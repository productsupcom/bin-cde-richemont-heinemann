env.name                       = "bin-cde-richemont-heinemann"
env.description                = "bin-cde-richemont-heinemann"
env.maintainer                 = "Channel Dev Team <featureteam@productsup.com>"
env.homepage                   = "https://github.com/productsupcom/bin-cde-richemont-heinemann"
